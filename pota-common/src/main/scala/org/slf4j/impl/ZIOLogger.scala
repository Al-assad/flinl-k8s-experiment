...
class ZIOLogger(name: String, factory: ZIOLoggerFactory) extends MarkerIgnoringBase {
  ...
  override def debug(msg: String, t: Throwable): Unit =
    run(ZIO.logDebugCause(msg, Option(t).map(t => Cause.die(t)).getOrElse(Cause.empty)))
  ...
  override def info(msg: String, t: Throwable): Unit =
    run(ZIO.logInfoCause(msg, Option(t).map(t => Cause.die(t)).getOrElse(Cause.empty)))
  ...
  override def warn(msg: String, t: Throwable): Unit =
    run(ZIO.logWarningCause(msg, Option(t).map(t => Cause.die(t)).getOrElse(Cause.empty)))
  ...
  override def error(msg: String, t: Throwable): Unit =
    run(ZIO.logErrorCause(msg, Option(t).map(t => Cause.die(t)).getOrElse(Cause.empty)))
